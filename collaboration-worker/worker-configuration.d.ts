/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=collaboration-worker/wrangler.jsonc collaboration-worker/worker-configuration.d.ts` (hash: 93b2203a51a3f69d2688773f2198f3d5)
// Runtime types generated with workerd@1.20260820.1 2026-08-23 nodejs_compat
interface __BaseEnv_Env {
  BROWSER: BrowserRun;
  ALLOWED_ORIGINS:
    | "https://ephemeral.schalkneethling.com"
    | "https://deploy-preview-33--ephemeral-pages.netlify.app"
    | "http://localhost:5173";
  TICKET_AUDIENCE: "ephemeral-pages-collaboration" | "ephemeral-pages-collaboration-preview";
  PAGE_CONTENT_ORIGIN:
    | "https://ephemeral.schalkneethling.com"
    | "https://deploy-preview-33--ephemeral-pages.netlify.app"
    | "http://localhost:5173";
  PUBLIC_WORKER_ORIGIN:
    | "https://ephemeral-pages-collaboration.volume4-schalk.workers.dev"
    | "https://ephemeral-pages-collaboration-preview.volume4-schalk.workers.dev"
    | "http://localhost:8787";
  TICKET_HMAC_SECRET: string;
  ADMIN_TOKEN: string;
  COLLABORATION_ROOMS: DurableObjectNamespace<import("./src/index").CollaborationRoom>;
}
declare namespace Cloudflare {
  ...
  interface ProductionEnv {
    BROWSER: BrowserRun;
    ALLOWED_ORIGINS: "https://ephemeral.schalkneethling.com";
    TICKET_AUDIENCE: "ephemeral-pages-collaboration";
    PAGE_CONTENT_ORIGIN: "https://ephemeral.schalkneethling.com";
    PUBLIC_WORKER_ORIGIN: "https://ephemeral-pages-collaboration.volume4-schalk.workers.dev";
    TICKET_HMAC_SECRET: string;
    ADMIN_TOKEN: string;
    COLLABORATION_ROOMS: DurableObjectNamespace<import("./src/index").CollaborationRoom>;
  }
  interface PreviewEnv {
    BROWSER: BrowserRun;
    ALLOWED_ORIGINS: "https://deploy-preview-33--ephemeral-pages.netlify.app";
    TICKET_AUDIENCE: "ephemeral-pages-collaboration-preview";
    PAGE_CONTENT_ORIGIN: "https://deploy-preview-33--ephemeral-pages.netlify.app";
    PUBLIC_WORKER_ORIGIN: "https://ephemeral-pages-collaboration-preview.volume4-schalk.workers.dev";
    TICKET_HMAC_SECRET: string;
    ADMIN_TOKEN: string;
    COLLABORATION_ROOMS: DurableObjectNamespace<import("./src/index").CollaborationRoom>;
  }
